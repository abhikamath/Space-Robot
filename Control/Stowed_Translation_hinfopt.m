%% Astrobee Stowed H-infinity Control Design for Translation (hinfopt)
...
Gc_Stowed_Translation_hinfopt = Gc;
save('Matrices/Gc_Stowed_Translation_hinfopt.mat', 'Gc_Stowed_Translation_hinfopt');
